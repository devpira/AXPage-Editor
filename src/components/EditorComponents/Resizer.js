...
export const Resizer = ({ propKey, children, minWidth, minHeight, maxHeight, maxWidth, allowedSides, ...props }) => {
  const {
    id,
    actions: { setProp },
  ...
  return (
    <Resizable
      enable={[
        ...
        acc[key] = active && inNodeContext && (allowedSides ? allowedSides.includes(key) : true);
        return acc;
      }, {})}
      className={cx([
        {
